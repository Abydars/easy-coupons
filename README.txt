...
1. Upload `easy-coupons.php` to the `/wp-content/plugins/` directory
...
[ ] Create a plugin called "Easy Coupons" with the following features:
  [ ] As an admin, I should be able to bulk generate any quantity of randomly generated, unique 4 character alpha-numeric coupon codes (ex. f5Ba, 891d, etc.) - DONE
  [ ] As an admin, I should be able to search and delete any individual coupon code - DONE
  [ ] As an admin, I should be able to specify an expiry date when I generate coupon codes - DONE
  [ ] As an admin, I should be able to bulk delete coupons based on expiry date - DONE
